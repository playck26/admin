 ...
 * instalável. Só o `cliente` foi: `admin.playck.com.br/manifest.webmanifest`
 ...
 * este é um painel de gestão, usado tanto no celular na beira da quadra como
 * no desktop. Travar orientação aqui quebraria justamente o uso de mesa, onde
 * a agenda e as tabelas precisam de largura.
 */
export default function manifest(): MetadataRoute.Manifest {
  return {
    id: "/",
    name: "PlayCK Admin",
    short_name: "PlayCK Admin",
    description: "Painel do dono da escola/arena — PlayCK",
    start_url: "/",
    scope: "/",
    display: "standalone",
    lang: "pt-BR",
