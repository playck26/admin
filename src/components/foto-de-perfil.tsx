 ...
 *
 * Este componente é **duplicado** no `cliente` (ADR-001, poly-repo).
 */
  ...
  return (
    <section className="flex flex-col items-center gap-4">
      <div className="relative">
        <div className="flex size-32 items-center justify-center overflow-hidden rounded-full bg-white ring-1 ring-border">
          {estado === "carregando" ? (
            <Loader2
              className="size-8 animate-spin text-[var(--color-on-surface-variant)]"
              aria-hidden="true"
            />
          ) : url ? (
            ...
            <User
              className="size-12 text-[var(--color-on-surface-variant)]"
              aria-hidden="true"
            />
          )}
        </div>
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="flex min-h-11 items-center gap-2 rounded-2xl bg-[var(--color-primary-strong)] px-4 text-sm font-bold text-white transition-transform active:scale-95 disabled:opacity-60"
        >
        ...
        {url ? (
          <button
            ...
            className="flex min-h-11 items-center gap-2 rounded-2xl bg-white px-4 text-sm font-bold text-[var(--color-on-surface-variant)] ring-1 ring-border transition-colors hover:text-[var(--color-primary-strong)] disabled:opacity-60"
          >
      ...
      <p className="max-w-xs text-center text-xs text-[var(--color-on-surface-variant)]">
