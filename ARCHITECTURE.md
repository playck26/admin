...
componentes** — o novo é `vencimentos-card` (SPEC-045). *O número de componentes não mudou no DEF-027: entrou um bloco
dentro de `edit-student-form`, não um componente novo — desligar aluno é ação
da ficha, no molde de `edit-teacher-form`.*
