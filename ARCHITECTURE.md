...
**Conferido por comando nesta data:** 31 arquivos de teste, 308 casos, **61
componentes** (`vitest run --pool=threads`; `ls src/components`). *A linha de
2026-09-11 dizia 27/238/58 e já estava atrás do código — a SPEC-050 registrou
30/306. A SPEC-052 soma um arquivo de teste e nenhum componente.* Registro de
