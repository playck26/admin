...
**Fonte: análise direta do código.** Data: **2026-09-14** (era 2026-09-11).
**Conferido por comando nesta data:** 33 arquivos de teste, 315 casos, **62
componentes** (`vitest run --pool=threads`; `.tsx` de `src/components`). *A linha de
2026-09-11 dizia 27/238/58 e já estava atrás do código — a SPEC-050 registrou
